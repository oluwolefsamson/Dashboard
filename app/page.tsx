      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          <p className={`${lusitana.className} text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>Welcome to Oluwole Samson Olawumi Dashboard.</strong> This design is {' '}
            <a href="https://nextjs.org/learn/" className="text-green-500">
              
            </a>
              Brought to you by Samtech.
          </p>
          <Link
            href="../dashboard"
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          ...
          <Image
            ...
            width={700}
            height={300}
            className="hidden md:block rounded-lg border border-gray-300 p-4"
          ...
          <Image
            ...
            width={560}
            height={620}
            className="block md:hidden rounded-sm border border-gray-300 p-4"
